...
<body>
    ...
    <div id="main">
        ...
        <label for="header"><h1>Add Page</h1></label>
        </div>

        <form action="/store-donation" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="form-box">
            ...
            <div class="form-input">
                ...
                <input type="number" id="people" name="Limit" value=""/>
            </div>
            <div class="form-input">

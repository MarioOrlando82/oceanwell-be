        ...
        <div class="Content-Wrapper">
            ...
            <div class="Mid-Content">
                ...
                <div class="Target-Wrapper">
                    <h2 id="CurrentNumber">Rp.{{$donation->Total}}</h2>&nbsp;<h2>Dari</h2>&nbsp;<h2 id="TargetNumber">Rp.{{$donation->Limit}}</h2>
                </div>
            </div>

            <div class="Right-Content">

                <form id="donationForm" action="/update-total/{{ $donation->id }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <div class="InputWrapper">
                        <input type="text" id="donationAmount" name="Total" placeholder="Masukkan Nominal Donasi">
                    </div>
                    <br>
                    <div class="SubmitBtn">
                        ...
                        <div class="announcement">
                            <div class="Announcement-Wrapper">
                                ...
                                <div class="Announcement-Text">
                                    ...
                                    <h3>Dana yang Anda berikan akan segera kami berikan kepada orang yang membutuhkan. Terima kasih!</h3>
                                </div>

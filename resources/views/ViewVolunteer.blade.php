        ...
        <div class="Content-Wrapper">
            ...
            <div class="Mid-Content">
                ...
                <div class="Target-Wrapper">
                    <h2 id="CurrentNumber">{{$volunteer->Total}} Orang</h2>&nbsp;<h2>Dari</h2>&nbsp;<h2 id="TargetNumber">{{$volunteer->People}} Orang</h2>
                </div>
            </div>

            <div class="Right-Content">

                <form id="donationForm" action="/update-total/{{ $volunteer->id }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <div class="InputWrapper">
                        <input type="text" id="donationAmount" name="Total" placeholder="Masukkan Jumlah Orang">
                    </div>
                    <br>
                    <div class="SubmitBtn">
